...
class Compte extends \App\Entity\Compte implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getSoldeInitial(): ?int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSoldeInitial', []);

        return parent::getSoldeInitial();
    }

    /**
     * {@inheritDoc}
     */
    public function setSoldeInitial(int $soldeInitial): \App\Entity\Compte
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSoldeInitial', [$soldeInitial]);

        return parent::setSoldeInitial($soldeInitial);
    }
     ...
     * {@inheritDoc}
     */
    public function getTransacDepot(): \Doctrine\Common\Collections\Collection
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTransacDepot', []);

        return parent::getTransacDepot();
    }

    /**
     * {@inheritDoc}
     */
    public function addTransacDepot(\App\Entity\Transaction $transacDepot): \App\Entity\Compte
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addTransacDepot', [$transacDepot]);

        return parent::addTransacDepot($transacDepot);
    }

    /**
     * {@inheritDoc}
     */
    public function removeTransacDepot(\App\Entity\Transaction $transacDepot): \App\Entity\Compte
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeTransacDepot', [$transacDepot]);

        return parent::removeTransacDepot($transacDepot);
    }

    /**
     * {@inheritDoc}
     */
    public function getTransactRetrait(): \Doctrine\Common\Collections\Collection
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTransactRetrait', []);

        return parent::getTransactRetrait();
    }

    /**
     * {@inheritDoc}
     */
    public function addTransactRetrait(\App\Entity\Transaction $transactRetrait): \App\Entity\Compte
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addTransactRetrait', [$transactRetrait]);

        return parent::addTransactRetrait($transactRetrait);
    }

    /**
     * {@inheritDoc}
     */
    public function removeTransactRetrait(\App\Entity\Transaction $transactRetrait): \App\Entity\Compte
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeTransactRetrait', [$transactRetrait]);

        return parent::removeTransactRetrait($transactRetrait);
    }
