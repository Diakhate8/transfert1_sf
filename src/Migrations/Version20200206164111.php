 ...
 */
final class Version20200206164111 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE partenaire (id INT AUTO_INCREMENT NOT NULL, numero_compte VARCHAR(255) NOT NULL, ninea VARCHAR(255) NOT NULL, rc VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_32FFA3739731415A (numero_compte), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
